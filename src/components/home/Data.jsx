...
const Data = () => {
 ...
 <div className="home_data">
    <h1 className="home title">Rohit Gundeti
    <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
    ...
    <p className="home__description">I'm computer science engineer based in India, and I'm very passionate and dedicated to my work.</p>
